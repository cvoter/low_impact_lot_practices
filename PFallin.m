        ...
        for transverse = 0:1
            for microType = 0:1
                for soilnum = 1:3
                    ...
                    locname = 'loc51';%'loc01'; %used to load a) met forcing, b) 1D spinup
                    ...
                    lotname = sprintf('Lot%d%d%d%d',downspout,sidewalk,transverse,microType); %used to load outputs from PFlots (slopes, subsurfaceFeature, domainInfo, drv_vegm)
                    metyear = 'SP81'; % used to load met forcing
                    starttype = 'sp'; %used to load 1D spinup
